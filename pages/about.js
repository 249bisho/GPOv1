...
export default function About() {
  ...
  const content = {
    en: {
      ...
      founder: "Bashir A.",
      role: "Founder & CEO",
      bio: "Leading the vision for a high-design, high-execution BPO that connects global markets.",
    ...
    ar: {
      ...
      bio: "قيادة الرؤية لمنظومة تعهيد عالية التنفيذ تربط الأسواق العالمية.",
  ...
  return (
    <div className="bg-white min-h-screen text-slate-900">
      ...
      {/* Hero Header - Modern Glassdoor Style */}
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        <h2 className="text-2xl font-bold tracking-tight text-slate-900 mb-12">{t.leadership}</h2>
        
        <section className="grid md:grid-cols-3 gap-12 items-start">
          
          {/* BASHIR.A - ELEGANT CLIENT CARD */}
          <div className="card-client reveal">
          ...
          {/* Delivery Lead */}
          <div className="reveal delay-1 pt-10">
            <h3 className="text-xl font-bold mb-2">Delivery Lead</h3>
            <p className="text-xs font-bold text-[#0CAA41] uppercase tracking-widest mb-4">Operations</p>
            <p className="text-slate-600 leading-relaxed">
              Managing 24/7 workflows and ensuring quality across all client campaigns with rigorous standards.
            </p>
          </div>

          {/* Talent Lead */}
          <div className="reveal delay-2 pt-10">
            <h3 className="text-xl font-bold mb-2">Talent Lead</h3>
            <p className="text-xs font-bold text-[#0CAA41] uppercase tracking-widest mb-4">Recruitment</p>
            <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-32 py-16 border-t border-gray-100 text-center max-w-4xl mx-auto reveal">
